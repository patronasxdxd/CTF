  ...
  return (
    <nav className="w-full flex md:justify-center justify-between items-center p-4">
      ...
      <ul className="text-white flex space-x-4">
        ...
        <a class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded" target="_blank" href="https://github.com/patronasxdxd/CTF">Gitub code</a>
